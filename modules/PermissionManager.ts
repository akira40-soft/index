...
class PermissionManager {
    ...
    constructor(logger: any = console, registrationSystem: any = null) {
        ...
        this.commandPermissions = {
            ...
            'except': { nivel: 'admin', requiresRegistration: true, rateLimitMultiplier: 1, grupo: true },
            'excep': { nivel: 'admin', requiresRegistration: true, rateLimitMultiplier: 1, grupo: true },
